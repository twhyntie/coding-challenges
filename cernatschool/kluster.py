...
class Kluster:
    ...
    def __init__(self, rows, cols, ismc):
        ...
        # Unweighted (u subsctript) properties.

        ## The cluster radius (unweighted).
        self.r_u     = -1.0

        ## The cluster's spatial density (unweighted).
    ...
    def getKlusterPropertiesJson(self):
        ...
        p = {\
            ...
            "n_edgepixels"  : self.getNumberOfEdgePixels(), \
            "edgefrac"      : self.getOuterPixelFraction(), \
            "innerfrac"     : self.getInnerPixelFraction(), \
            "ismc"          : self.isMC(),                  \
            "isedgekluster" : self.isEdgeCluster(),         \
            #"totalenergy"   :, \
            #"maxenergy"     :, \
            #"frameid"       :\
            }
...
class KlusterFinder:
    ...
    def __init__(self, data, r, c, ismc=False, maskdict={}):
        ...
        self.dbg = False # True - for debugging print statements.

        ## A map of the pixels in a dictionary: {X:Pixel}.
        self.pixels = {} # map of {XY: Pixel}

        ## A list of the clusters found.
        self.blob_list = []

        ## The number of pixel rows in the data frame.
        self.rows = r

        ## The number of pixel columns in the data frame.
        self.cols = c

        ## Are we looking at simulated data?
        self.__is_mc = ismc

        ## The dictionary of pixels of the frame.
